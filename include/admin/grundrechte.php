...
<tr>
     <td colspan="3" class="Cdark"><input type="submit" value="&Auml;nderungen speichern" name="o" /> (<a href="admin.php?grundrechte=0&m=m">Modulrechte f&uuml;r Grundrechte)</a></td>
  </tr>
  <?php
  $class = '';
  $erg = db_query("SELECT * FROM prefix_grundrechte ORDER BY id ASC");
  ...
  ?>
  <tr>
     <td colspan="3" class="Cdark"><input type="submit" value="&Auml;nderungen speichern" name="o" /></td>
  </tr>
</table>
