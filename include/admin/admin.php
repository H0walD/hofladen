  ...
  <tr>
    <td class="Cnorm">
	     ...
	     <li class="admix_box">Statistik<br />
             ...
             <li class="admix_box">Online-Shop / Laden<br />
               <ul>
                 <li><a href="admin.php?groups"><img src="include/images/icons/admin/teams.png" alt="" />Shop</br>Teams</a></li>
                 <li><a href="admin.php?shopinfo"><img src="include/images/icons/admin/shopinfo.png" alt="" />Shop</br>Info</a></li>
                 <li><a href="admin.php?shop"><img src="include/images/icons/admin/shop.png" alt="" />Shop</a></li>
                 <li><a href="admin.php?shop-category"><img src="include/images/icons/admin/shop-category.png" alt="" />Shop</br>Kategorien</a></li>
                 <li><a href="admin.php?shop-article"><img src="include/images/icons/admin/shop-article.png" alt="" />Shop</br>Artikel</a></li>
                 <li><a href="admin.php?agb"><img src="include/images/icons/admin/agb.png" alt="" />Shop</br>AGB</a></li>
                 <br class="admix_last"/>
               </ul>
             </li>
