...
if (db_num_rows($erg)) {
	...
	$avatar = '';
	 if(empty($row['avatar'])){
                $avatar = '<img class="img-thumbnail" src="/include/images/avatars/gast.png"  border="0">';
                    } else {
                $avatar = '<img class="img-thumbnail" src="'.$row['avatar'].'" alt="Avatar von '.$row['name'].'" border="0" >';
                                }
