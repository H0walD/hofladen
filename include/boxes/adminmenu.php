...
if ( is_coadmin() ) {
  ?>
    ...
    [null, 'Online-Shop / Laden', null, null, null,
      ['<img src="include/images/icons/admin/teams.png" width="16" height="16">', 'Shop-Teams', 'admin.php?groups', null, null],
      ['<img src="include/images/icons/admin/shopinfo.png" width="16" height="16">', 'Shop-Info', 'admin.php?shopinfo', null, null],
      ['<img src="include/images/icons/admin/shop.png" width="16" height="16">', 'Shop', 'admin.php?shop', null, null],
      ['<img src="include/images/icons/admin/shop-category.png" width="16" height="16">', 'Shop-Kategorie', 'admin.php?shop-category', null, null],
      ['<img src="include/images/icons/admin/shop-article.png" width="16" height="16">', 'Shop-Artikel', 'admin.php?shop-article', null, null],
      ['<img src="include/images/icons/admin/agb.png" width="16" height="16">', 'AGB', 'admin.php?agb', null, null],
    ],
