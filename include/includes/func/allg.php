...
function getsmilies () {
  global $lang;
  $zeilen = 4; $i = 0;
	$b = '<script language="JavaScript" type="text/javascript">function moreSmilies () { var x = window.open("about:blank", "moreSmilies", "width=300,height=350,status=no,scrollbars=yes,resizable=yes"); ';
  $a = '';
  ...
  if ($i>12) { $a .= '<br /><br /><center><a href="javascript:moreSmilies();" class="btn btn-success">'.$lang['more'].'</a></center>'; }
  $a = $b.$a;
  return ($a);
}
...
function get_antispam($m, $t, $nopictures = false)
{
    ...
    $img = '<img width="' . $imagewidth . '" height="' . $imageheight . '" src="include/includes/captcha/captchaimg.php?id='
        ...
        . $seperator . '<input class="capatchafeld" name="captcha_code" type="text" maxlength="5" size="8" data-toggle="tooltip" data-placement="right" title="" data-original-title="Geben Sie die Zeichen aus dem Bild ein">'
